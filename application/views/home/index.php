		...
		<div class="row justify-content-center fullscreen align-items-center">
			<div class="col-lg-5 col-md-8 home-banner-left">
				...
				<p class="mx-auto text-white  mt-20 mb-40">
					Ingin tahu tentang UKM di STMIK Lombok dan kegiatan kegiatan yang pernah dilakukan ? <br>
					maka kalian tidak salah untuk mendatangi situs ini. Selamat belajar dan semoga memberikan inspirasi
				</p>
			</div>
			<div class="offset-lg-2 col-lg-5 col-md-12 home-banner-right">
				<img class="img-fluid" src="<?= base_url('assets') ?>/img/header-img.svg" alt="" />
			</div>
		</div>
	</div>
</section>
			...
			<div class="col-lg-2 col-md-6">
				<div class="feature-item d-flex">
					...
					<div class="ml-20">
						<h4>Mau Belajar ?</h4>
						<p>
							Kami menyediakan tutorial dan yang diharapkan mampu membantu teman teman untuk meningkatkan pengetahuannya
						</p>
					</div>
				</div>
			</div>
			<div class="col-lg-2 col-md-6">
				<div class="feature-item d-flex">
					...
					<div class="ml-20">
						<h4>Prestasi</h4>
						<p>
							Jika pengen tahu kegiatan dan prestasi yang kami capai bisa cek langsung pada menu kegiatan dan berita
						</p>
					</div>
				</div>
			</div>
			<div class="col-lg-2 col-md-6">
				<div class="feature-item d-flex border-right-0">
					...
					<div class="ml-20">
						...
						<p>
							Pengen nambah wawasan ? disini bisa juga kok kami menyediakan artikel yang selalu update dengan perkembangan tekhnologi
						</p>
					</div>
				</div>
			</div>
	...
	<div class="container-fluid">
		...
		<div class="owl-carousel popuar-course-carusel">
			<div class="single-popular-course">
				<div class="thumb">
					<img class="f-img img-fluid mx-auto" src="<?= base_url('assets') ?>/img/popular-course/p1.jpg" alt="" />
				</div>
				<div class="details">
			...
			<div class="single-popular-course">
				<div class="thumb">
					<img class="f-img img-fluid mx-auto" src="<?= base_url('assets') ?>/img/popular-course/p2.jpg" alt="" />
				</div>
				<div class="details">
					<div class="d-flex justify-content-between mb-20">
						<p class="name">programming language</p>
			...
			<div class="single-popular-course">
				<div class="thumb">
					<img class="f-img img-fluid mx-auto" src="<?= base_url('assets') ?>/img/popular-course/p3.jpg" alt="" />
				</div>
				<div class="details">
					<div class="d-flex justify-content-between mb-20">
						<p class="name">programming language</p>
			...
			<div class="single-popular-course">
				<div class="thumb">
					<img class="f-img img-fluid mx-auto" src="<?= base_url('assets') ?>/img/popular-course/p4.jpg" alt="" />
				</div>
				<div class="details">
					<div class="d-flex justify-content-between mb-20">
						<p class="name">programming language</p>
				...
				<div class="owl-carousel video-carousel">
					<div class="single-video">
						<div class="video-part">
							<img class="img-fluid" src="<?= base_url('assets') ?>/img/video-img.jpg" alt="">
							<div class="overlay"></div>
							<a class="popup-youtube play-btn" href="https://www.youtube.com/watch?v=VufDd-QL1c0">
								<img class="play-icon" src="<?= base_url('assets') ?>/img/play-btn.png" alt="">
							</a>
						</div>
		...
		<div class="testi-slider owl-carousel" data-slider-id="1">
			<div class="row align-items-center">
				...
				<div class="offset-lg-1 col-lg-6">
					<img src="<?= base_url('assets') ?>/img/testimonial/t1.jpg" alt="" />
				</div>
			</div>
			...
			<div class="offset-lg-3 col-lg-4 col-md-6">
				<div class="course-form-section">
					...
					<form class="course-form-area contact-page-form course-form text-right" id="myForm" action="mail.html" method="post">
						...
						<div class="form-group col-md-12">
							<input type="text" class="form-control" id="subject" name="subject" placeholder="Phone Number" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Phone Number'">
						</div>
						<div class="form-group col-md-12">
		...
		<div class="feature-inner row">
			...
			<div class="col-lg-4 col-md-6">
				<div class="single-blog-post">
					<img src="<?= base_url('assets') ?>/img/blog-post/b1.jpg" class="img-fluid" alt="" />
					<div class="overlay"></div>
					<div class="top-text">
						<p>29th, oct, 2018</p>
						<p>121 likes</p>
			...
			<div class="col-lg-4 col-md-6 mt--160">
				<div class="single-blog-post">
					<img src="<?= base_url('assets') ?>/img/blog-post/b2.jpg" class="img-fluid" alt="" />
					<div class="overlay"></div>
					<div class="top-text">
						<p>29th, oct, 2018</p>
						<p>121 likes</p>
			...
			<div class="col-lg-4 col-md-6 mt--260">
				<div class="single-blog-post">
					<img src="<?= base_url('assets') ?>/img/blog-post/b3.jpg" class="img-fluid" alt="" />
					<div class="overlay"></div>
					<div class="top-text">
						<p>29th, oct, 2018</p>
						<p>121 likes</p>
